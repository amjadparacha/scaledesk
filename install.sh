...
c=n d=n h=n i=n I=n l=n r=n s=n u=n U=n w=n v=n W=n K=n C=n BRANCH=df_updates SERVICE=web DEPLOYMENT_TYPE=full CONVERT_TO=""
...
function setup_chatwoot() {
  ...
  git clone https://github.com/amjadparacha/scaledesk.git
  cd scaledesk
  git checkout "$BRANCH"
  bundle
  pnpm i
...
function get_console() {
  sudo -i -u chatwoot bash -c " cd scaledesk && RAILS_ENV=production bundle exec rails c"
}
